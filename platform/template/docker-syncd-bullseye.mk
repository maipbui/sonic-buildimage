...
$(DOCKER_SYNCD_BASE)_RUN_OPT += --cap-add=SYS_RAWIO --cap-add=SYS_ADMIN --cap-add=NET_ADMIN --cap-add=NET_RAW -t
$(DOCKER_SYNCD_BASE)_RUN_OPT += --security-opt apparmor=unconfined --security-opt="systempaths=unconfined"
